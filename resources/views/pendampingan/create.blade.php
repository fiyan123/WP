<x-app-layout>
                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('staff.pendampingan.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="tempat_pendampingan" class="block mt-1 w-full" type="text" name="tempat_pendampingan" :value="old('tempat_pendampingan')" required autocomplete="tempat_pendampingan" />
                        ...
                        <div>
                            ...
                            <select id="konfirmasi" name="konfirmasi" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                <option value="{{ \App\Models\Pendampingan::STATUS_BUTUH_KONFIRMASI_STAFF }}" {{ old('konfirmasi') == \App\Models\Pendampingan::STATUS_BUTUH_KONFIRMASI_STAFF ? 'selected' : '' }}>
                                    Butuh Konfirmasi Staff
                                </option>
                                <option value="{{ \App\Models\Pendampingan::STATUS_MENUNGGU_KONFIRMASI_USER }}" {{ old('konfirmasi') == \App\Models\Pendampingan::STATUS_MENUNGGU_KONFIRMASI_USER ? 'selected' : '' }}>
                                    Menunggu Konfirmasi User
                                </option>
                                <option value="{{ \App\Models\Pendampingan::STATUS_TERKONFIRMASI }}" {{ old('konfirmasi') == \App\Models\Pendampingan::STATUS_TERKONFIRMASI ? 'selected' : '' }}>
                                    Terkonfirmasi
                                </option>
                                <option value="{{ \App\Models\Pendampingan::STATUS_DIBATALKAN }}" {{ old('konfirmasi') == \App\Models\Pendampingan::STATUS_DIBATALKAN ? 'selected' : '' }}>
                                    Dibatalkan
                                </option>
                            </select>
                            <p class="mt-1 text-sm text-gray-500">Biarkan kosong untuk default "Menunggu Konfirmasi User"</p>
                        ...
                        <!-- <div>
                            ...
                            <textarea id="catatan" name="catatan" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('catatan') }}</textarea>
    ...
    <div id="pengaduan-data" 
         ...
         data-old-nama-pendamping="{{ old('nama_pendamping') }}"
         style="display: none;">
    </div>
                    ...
                    if (selectedLayanan) {
                        ...
                        if (filteredInstrukturs.length > 0) {
                            ...
                            filteredInstrukturs.forEach(function(instruktur) {
                                ...
                                if (oldNamaPendamping && instruktur.nama === oldNamaPendamping) {
