...
@section('content_template')
    <section class="bg-white py-8 px-4 sm:px-8 lg:px-12 rounded-lg shadow-md mt-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
            ...
            <button class="bg-gray-400 hover:bg-gray-500 text-white text-sm font-medium py-2 px-5 rounded flex items-center gap-2 transition">
        ...
        <div class="bg-white rounded shadow p-6">
            <h3 class="font-bold text-gray-900 text-base mb-6">Layanan Pendampingan Korban</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12 mb-8">
                <div>
                    <div class="mb-4">
                        <span class="block text-sm text-gray-600 font-medium">Jenis Pendampingan</span>
                        <span class="block text-gray-800 mt-1">Pendampingan Layanan Kesehatan</span>
                    </div>
                    <div>
                        <span class="block text-sm text-gray-600 font-medium">Tanggal Pendampingan</span>
                        <span class="block text-gray-800 mt-1">15 - 02 - 2025</span>
                    </div>
                </div>
                <div>
                    <div class="mb-4">
                        <span class="block text-sm text-gray-600 font-medium">Catatan</span>
                        <span class="block text-gray-800 mt-1">-</span>
                    </div>
                    <div>
                        <span class="block text-sm text-gray-600 font-medium">Waktu Pendampingan</span>
                        <span class="block text-gray-800 mt-1">09 : 00</span>
                    </div>
                </div>
            </div>
            <hr class="my-4 border-gray-200">
            <div class="flex flex-col md:flex-row justify-center gap-4 mt-8">
                <button class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-14 rounded transition">Hadir</button>
                <button class="bg-blue-200 text-white font-semibold py-2 px-8 rounded transition">Berhalangan Hadir</button>
            </div>
        </div>
    </section>
@endsection
