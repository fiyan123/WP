        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('staff.assessment.store') }}" method="POST">
                        @csrf
                        ...
                        <input type="hidden" name="nama_korban" id="nama_korban">

                        <div class="mb-4">
                            <x-input-label for="nama_assessor" :value="__('Nama Assessor')" />
                            <x-text-input id="nama_assessor" name="nama_assessor" type="text" class="mt-1 block w-full" :value="old('nama_assessor')" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="tanggal_assesment" name="tanggal_assesment" type="datetime-local" class="mt-1 block w-full" :value="old('tanggal_assesment')" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="tempat_assessment" name="tempat_assessment" type="text" class="mt-1 block w-full" :value="old('tempat_assessment')" required />
